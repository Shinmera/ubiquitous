...
(defun restore (&optional (designator *storage-pathname*) (type *storage-type*))
...
(defun offload (&optional (designator *storage-pathname*) (type *storage-type*) (storage *storage*))
  (let* ((pathname (designator-pathname designator type))
